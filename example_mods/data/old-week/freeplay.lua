...
local songData = {
{"HFS-old","HFS-old","HFS-old"},
{"invade-old","invade-old","invade-old"},
{"meme-mania-old","meme-mania-old","meme-mania-old"},
{"funny-cartoon-old","old-pibby-tom","funny-cartoon-old"},
{"vanishing-old","Vanishing-old","Vanishing-old"}
}
...
makeLuaSprite('image', 'freeplay/pictures/'..songData[ProductSelected][2], 0, 292)
addLuaSprite('image', true)
setScrollFactor('image', 1, 1);
setProperty('image.x', 980-getProperty('image.width')/2)
